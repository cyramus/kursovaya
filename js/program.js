...
class ProgramPage {
    ...
    updateDayTabs() {
        ...
        tabs.forEach(tab => {
            ...
            if (day === this.currentDay) {
                tab.classList.add('program-days__tab_active');
                tab.setAttribute('aria-selected', 'true');
            } else {
                tab.classList.remove('program-days__tab_active');
    ...
    createEventCard(event) {
        ...
        return `
            <article class="event-card event-card_type_${event.type}" data-type="${event.type}" data-id="${event.id}" itemscope itemtype="https://schema.org/Event">
                ...
                <div class="event-card__actions">
                    <button class="btn btn_primary event-card__btn" data-action="details" data-id="${event.id}">
                        Подробнее
                    </button>
                    <button class="btn btn_secondary event-card__btn" data-action="add" data-id="${event.id}">
    ...
    openModal(eventId) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="modal__actions">
                <button class="btn btn_primary" data-action="add" data-id="${event.id}">
                    Добавить в расписание
                </button>
            </div>
        `;
