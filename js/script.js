    ...
    navLinks.forEach(link => {
        link.addEventListener('click', () => {
            if (window.innerWidth < 768) {
                navList.classList.remove('nav__list_open');
...
class HeroSlider {
    constructor() {
        ...
        this.prevBtn = document.querySelector('.hero__control_prev');
        this.nextBtn = document.querySelector('.hero__control_next');
        this.currentSlide = 0;
    ...
    goToSlide(index) {
        ...
        this.slides[this.currentSlide].classList.remove('hero__slide_active');
        this.dots[this.currentSlide].classList.remove('hero__dot_active');

        // Update current slide
        this.currentSlide = index;

        // Add active class to new slide and dot
        this.slides[this.currentSlide].classList.add('hero__slide_active');
        this.dots[this.currentSlide].classList.add('hero__dot_active');
    }
...
const mapButton = document.querySelector('.btn_map');
if (mapButton) {
